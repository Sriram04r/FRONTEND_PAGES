...
const AdminFacultyManagement = () => {
  const facultyData = [
    { id: 1, name: 'Dr. A. Reddy', college: 'KIED', dept: 'CSE', branch: 'CSE-A', email: 'areddy@kied.edu', status: 'Active' },
    { id: 2, name: 'Ms. B. Kiran', college: 'KIEK', dept: 'AID', branch: 'AID-B', email: 'bkiran@kiek.edu', status: 'Active' },
    { id: 3, name: 'Mr. C. Meghana', college: 'KIEW', dept: 'Cyber', branch: 'Cyber-A', email: 'cmeghana@kiew.edu', status: 'Active' },
    { id: 4, name: 'Dr. D. Pavan', college: 'KIED', dept: 'CAI', branch: 'CAI-B', email: 'dpavan@kied.edu', status: 'Active' },
    { id: 5, name: 'Ms. E. Sneha', college: 'KIEK', dept: 'DS', branch: 'DS-A', email: 'esneha@kiek.edu', status: 'Active' },
  ];
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-2xl font-bold text-slate-800 tracking-tight">Faculty Management</h1>
        <p className="text-sm text-slate-500 mt-1">Manage approved faculty members.</p>
      </div>
            ...
            <TableBody>
              {facultyData.map((faculty) => (
                <TableRow key={faculty.id} className="hover:bg-slate-50/50">
                  ...
                  <TableCell className="text-slate-500 font-medium">{faculty.email}</TableCell>

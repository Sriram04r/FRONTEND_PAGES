    ...
    <div className="space-y-6 animate-in fade-in duration-500">
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-purple-700 to-fuchsia-700 p-8 text-white shadow-lg">
        ...
        <div className="relative z-10">
          ...
          <p className="text-purple-100 max-w-md">Head of Department â€“ Computer Science & Engineering</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4">
        {[
          { name: 'CSM', desc: 'Artificial Intelligence & Machine Learning', icon: Monitor, color: 'text-blue-600', bg: 'bg-blue-100', count: 12, hostel: 8, day: 4 },
          { name: 'CAI', desc: 'Artificial Intelligence', icon: GraduationCap, color: 'text-emerald-600', bg: 'bg-emerald-100', count: 6, hostel: 4, day: 2 },
          { name: 'CSD', desc: 'Data Science', icon: Database, color: 'text-rose-600', bg: 'bg-rose-100', count: 9, hostel: 5, day: 4 },
          { name: 'AID', desc: 'Artificial Intelligence & Data Science', icon: Cpu, color: 'text-blue-500', bg: 'bg-blue-50', count: 7, hostel: 4, day: 3 },
          { name: 'CSC', desc: 'Cyber Security', icon: Shield, color: 'text-fuchsia-600', bg: 'bg-fuchsia-100', count: 10, hostel: 6, day: 4 },
        ].map((branch, i) => (

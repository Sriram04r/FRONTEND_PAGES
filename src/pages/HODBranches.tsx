          ...
          <Table>
            ...
            <TableBody>
              <TableRow className="hover:bg-slate-50 border-slate-100">
                ...
                <TableCell className="text-slate-600">Computer Science & Engineering</TableCell>
              ...
              <TableRow className="hover:bg-slate-50 border-slate-100">
                ...
                <TableCell className="text-slate-600">Computer Applications & Informatics</TableCell>
              ...
              <TableRow className="hover:bg-slate-50 border-slate-100">
                ...
                <TableCell className="text-slate-600">Computer Science & Data Science</TableCell>
              ...
              <TableRow className="hover:bg-slate-50 border-slate-100">
                ...
                <TableCell className="text-slate-600">Artificial Intelligence & Data</TableCell>
                <TableCell className="text-center font-semibold text-blue-600">4</TableCell>

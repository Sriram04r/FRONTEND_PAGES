...
import { Users, User, Lock, Eye, EyeOff, Mail, Phone, Building, BookOpen, Calendar, MapPin, ChevronDown } from 'lucide-react';
import { Card, CardContent, CardHeader, CardTitle, CardDescription, CardFooter } from '@/components/ui/card';
import { Input } from '@/components/ui/input';
import { Button } from '@/components/ui/button';

const CTPORegistration = () => {
    ...
    <div className="min-h-[90vh] flex items-center justify-center py-10 animate-in fade-in zoom-in-95 duration-500">
      <Card className="w-full max-w-lg shadow-xl border-slate-200 overflow-hidden relative">
        ...
        <CardHeader className="text-center pt-10 pb-6">
          ...
          <CardTitle className="text-2xl font-bold tracking-tight text-slate-900">CTPO Registration</CardTitle>
        ...
        <CardContent>
          <form onSubmit={(e) => e.preventDefault()} className="space-y-4">
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="relative">
                  ...
                  <select className="w-full pl-10 pr-10 h-12 rounded-xl bg-slate-50 border border-slate-200 text-slate-700 appearance-none focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent" defaultValue="">
            ...
            <Button className="w-full h-12 rounded-xl bg-blue-600 hover:bg-blue-700 text-white shadow-md mt-6">
              Register
            </Button>
          </form>
        </CardContent>
        ...
        <CardFooter className="justify-center border-t border-slate-100 bg-slate-50 py-4 mt-2">
          <p className="text-sm text-slate-600">
            Already have an account? <Link to="/login/ctpo" className="font-semibold text-blue-600 hover:text-blue-700 transition-colors">Login here</Link>
          </p>
        </CardFooter>
      </Card>
    </div>
...
export default CTPORegistration;

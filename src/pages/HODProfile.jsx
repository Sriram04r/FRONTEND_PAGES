import { Eye, EyeOff, User, Hash, Mail, Phone, Building, Briefcase, Lock, Camera } from 'lucide-react';
    ...
    <div className="max-w-md mx-auto space-y-4 pb-12 animate-in fade-in duration-500">
      ...
      <Card className="shadow-sm border-none bg-white rounded-3xl overflow-hidden">
        <CardContent className="p-6 flex flex-col items-center text-center">
          ...
          <h2 className="text-lg font-bold text-slate-900 mt-4">Dr. R. Sharma</h2>
          <p className="text-sm font-medium text-slate-600 mt-1">Faculty ID: HOD001</p>
          <p className="text-sm font-medium text-slate-600 mt-1">Head of Department | CSE</p>
      ...
      <Card className="shadow-sm border-none bg-white rounded-3xl overflow-hidden">
        ...
        <CardContent className="px-6 pb-6">
          <div className="space-y-4 mt-2">
            {[
              { icon: User, label: 'Full Name', value: 'Dr. R. Sharma' },
              { icon: Hash, label: 'Faculty ID', value: 'HOD001' },
              { icon: Mail, label: 'Email', value: 'rsharma.hod@college.edu' },
              { icon: Phone, label: 'Mobile Number', value: '9876543210' },
              { icon: Building, label: 'College', value: 'KIET' },
              { icon: Briefcase, label: 'Designation', value: 'Head of Department' },
              { icon: Building, label: 'Department', value: 'CSE' },
            ].map((item, index) => (

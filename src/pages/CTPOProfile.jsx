    ...
    <div className="max-w-md mx-auto space-y-4 pb-12 animate-in fade-in duration-500">
      ...
      <Card className="shadow-sm border-none bg-white rounded-3xl overflow-hidden">
        <CardContent className="p-6 flex flex-col items-center text-center">
          ...
          <p className="text-sm font-medium text-slate-600 mt-1">Faculty ID: FA1023</p>
          <p className="text-sm font-medium text-slate-600 mt-1">CTPO | CSM</p>
        ...
        <CardContent className="px-6 pb-6">
          <div className="space-y-4 mt-2">
            {[
              ...
              { icon: Hash, label: 'Faculty ID', value: 'FA1023' },
              { icon: Mail, label: 'Email', value: 'rsharma@college.edu' },
              { icon: Phone, label: 'Mobile Number', value: '9876543210' },
              { icon: Building, label: 'College', value: 'KIET' },
              { icon: Briefcase, label: 'Designation', value: 'CTPO' },
              { icon: Building, label: 'Department', value: 'CSM' },
            ].map((item, index) => (

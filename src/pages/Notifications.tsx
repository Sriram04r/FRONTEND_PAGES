      ...
      <Card className="shadow-sm border-slate-200">
        <CardContent className="p-6">
          <div className="flex flex-wrap gap-2 mb-6 border-b border-slate-100 pb-6">
            ...
            <Button variant="outline" className="rounded-full text-slate-600 bg-slate-50">Unread (2)</Button>
            <Button variant="outline" className="rounded-full text-slate-600 bg-slate-50">Approvals (3)</Button>
            <Button variant="outline" className="rounded-full text-slate-600 bg-slate-50">Updates (2)</Button>
          </div>

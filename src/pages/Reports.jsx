      ...
      <Card className="shadow-sm border-slate-200">
        <CardContent className="p-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Button className="flex-1 h-12 text-base shadow-md" onClick={() => handleDownload('CTPO_Permission_Report.pdf')}>
              <Download className="mr-2 w-5 h-5" /> Download PDF Report
            </Button>
            <Button variant="outline" className="flex-1 h-12 text-base text-emerald-600 border-emerald-200 hover:bg-emerald-50 hover:text-emerald-700" onClick={() => handleDownload('CTPO_Permission_Data.xlsx')}>

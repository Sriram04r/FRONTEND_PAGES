  ...
  return (
    <div>
      <div className="dash-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <button className="action-btn" style={{ background: '#4c1d95' }}>Edit Profile</button>
      </div>

      <div style={{ display: 'flex', gap: '32px' }}>
        <div className="dash-card" style={{ flex: 1, textAlign: 'center' }}>
          <div style={{ width: '100px', height: '100px', borderRadius: '50%', background: '#4c1d95', color: 'white', fontSize: '3rem', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 16px' }}>
            H
          </div>
          <h2 style={{ fontSize: '1.25rem', marginBottom: '4px' }}>Dr. R. Sharma</h2>
          <p style={{ color: '#64748b', fontSize: '0.9rem', marginBottom: '24px' }}>HOD | CSE</p>
          <button className="action-btn" style={{ background: '#4c1d95', marginBottom: '24px' }}>Change Photo</button>
        </div>
        ...
        <div className="dash-card" style={{ flex: 2 }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', marginBottom: '32px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '150px 1fr' }}>
              ...
              <span style={{ fontWeight: 500, color: '#1e293b' }}>Computer Science & Engineering</span>
            </div>
            <div style={{ display: 'grid', gridTemplateColumns: '150px 1fr' }}>
              <span style={{ color: '#64748b', fontSize: '0.9rem' }}>Designation</span>
              <span style={{ fontWeight: 500, color: '#1e293b' }}>Head of Department</span>
            </div>
            <div style={{ display: 'grid', gridTemplateColumns: '150px 1fr' }}>
          ...
          <form style={{ display: 'flex', gap: '16px', alignItems: 'flex-start' }} onSubmit={e => e.preventDefault()}>
          ...
          <div style={{ marginTop: '24px', textAlign: 'right' }}>
            <button className="action-btn" style={{ background: '#4c1d95', padding: '12px 32px' }}>Update Password</button>
          </div>
        </div>
      </div>
    </div>
